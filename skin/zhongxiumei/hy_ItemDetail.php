...
/*T_HOT+1*/
include("dbCfg.php");
mysqli_query($allDateBase, "update pru set T_HOT=T_HOT+1 where T_ID='".$_GET["T_ID"]."'");
    ...
    <div>
        <ul class="itemDetailText">
            ...
            <li id="buyCart"><form name="fmAdd" method="post" action="updateData.php?COM_ID=0001" style="padding:0px; margin:0px;">
				  ...
				  <input name="url" type="hidden" value="?p=viewCart"/>
                </form></li>
        </ul> 
    </div>
    	<?php
		...
		$result_all_message = mysqli_query($allDateBase, $sSql);
